...
def upload_photo():
    if request.method == 'POST':
        ...
        if file.filename == '':
            ...
            file.save(os.path.join(app.config['STATIC_FOLDER'], stored_file_name))
            print("SAVED img STATIC path: "+os.path.join(app.config['STATIC_FOLDER'], stored_file_name))            
            copyfile(os.path.join(app.config['STATIC_FOLDER'], stored_file_name), os.path.join(SAVE_DIR, stored_file_name))
            image = PIL.Image.open(os.path.join(app.config['STATIC_FOLDER'], stored_file_name))  # image to open
            ...
            generate_data(os.path.join(app.config['STATIC_FOLDER'], stored_file_name))
